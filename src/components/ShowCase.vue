...
<template>
  ...
  <div class="showcase-container w-full flex justify-center align-center py-24">
  ...
  <div class="showcase-img w-1/2 flex ">
  
  
  
    <img src="/public/showcase-img.svg" alt="" class="w-3/4 place-center self-center">
